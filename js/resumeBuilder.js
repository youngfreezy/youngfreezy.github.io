...
var bio = {
    ...
    display: function(){
    //at first I tried to do this with a for loop like in the work display function, but then I realized since there is only 
    //one set of contact information, don't need to a for loop. I did do a for loop on the skills section though!
    //can you please specify how I could have optimized this code?
